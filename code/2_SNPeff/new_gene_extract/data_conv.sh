...
#DIRECTORIES
OUTDIR=/proj/snic2022-6-164/MattC/dog_mitonuclear_conflict_project/alre/data/annotation/new_gene_vcf
...
geno_file = os.path.join(outdir, f"genotypes_load.tsv")
out_file  = os.path.join(outdir, f"geno_per_sample.tsv")
