...
declare -A FILTERS=(
  [HIGH]='INFO/ANN~"\|HIGH\|"'
  [SYN]='INFO/ANN~"\|MODERATE\|" && INFO/ANN!~"\|HIGH\|"'
  [NONSYN]='INFO/ANN~"\|LOW\|" && INFO/ANN!~"\|HIGH\|" && INFO/ANN!~"\|MODERATE\|"'
  [LOF]='INFO/ANN~"\|MODIFIER\|" && INFO/ANN!~"\|HIGH\|" && INFO/ANN!~"\|MODERATE\|" && INFO/ANN!~"\|LOW\|"'
  [NMD]='
)

for impact in LOW MODERATE HIGH MODIFIER
do
        #FILTERING MERGED SUBSET FILE AND OUTPUT OF GENOTYPE TABLES
